    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '<div class="Card-picture">' + '<a href="slug/' + book.slug + '">' + '<img src="' + book.image + '">\n' + '</a>' +
                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'tag':
                                ...
                                break;
                            case'search':
                                getData('/searchPage/' + $this.data('refreshquery'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        var newOffset = oldOffset + $this.data('refreshlimit');
                                        $this.data('refreshoffset', newOffset);
            ...
            return {
                init: function () {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        ;data.commentId = $this.data('likeid');
                        Login().postData('/rateBookComment', data, function (result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/rateBook', {
                            ...
                            if (result.result) {
                                ...
                                $title.addClass('Rating-title_error').text('Пользователь не авторизован');
                                        ...
                                        function sendData(address) {
                                            getData(address, {
                                                offset: function () {
                                                    ...
                                                    var newOffset = oldOffset + $(slick.$slider).data('loadlimit');
                                                    $(slick.$slider).data('loadoffset', newOffset);
