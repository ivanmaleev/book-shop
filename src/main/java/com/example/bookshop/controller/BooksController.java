...
public class BooksController extends CommonController {
    ...
    public String bookPage(@ModelAttribute BookRatingDto bookRating,
        ...
        CompletableFuture<BookDto> slugBookFuture = CompletableFuture.supplyAsync(() -> {
            BookDto book = null;
            try {
    ...
    public String getAuthorsBooksPage(@Min(value = 1) @PathVariable("id") long authorId,
        ...
        CompletableFuture<AuthorDto> authorFuture = CompletableFuture.supplyAsync(() -> {
        ...
        CompletableFuture<Collection<BookDto>> authorBooksFuture = authorFuture.
